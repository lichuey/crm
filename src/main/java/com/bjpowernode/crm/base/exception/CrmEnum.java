...
public enum CrmEnum {
    ...
    ACTIVITY_REMARK_SAVE_FALSE("001-001-001-001", "活动备注保存失败"),
    ACTIVITY_REMARK_UPDATE_FALSE("001-001-002-001", "活动备注更新失败"),
    ACTIVITY_REMARK_DELETE_FALSE("001-001-003-001", "活动备注删除失败"),
